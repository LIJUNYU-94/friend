export const batches = [
  {
    ...
    icon70: require("../../assets/images/batchfriend70.png"),
  ...
  {
    name: "stars",
    icon: require("../../assets/images/batchzodiac0.png"),
    icon50: require("../../assets/images/batchzodiac50.png"),
    icon70: require("../../assets/images/batchzodiac70.png"),
  ...
  },
  {
    ...
    icon70: require("../../assets/images/batchblood70.png"),
